...
export default function Header({className}: {className: string}) {
  ...
  return (
    <header className={`bg-transparent w-full absolute top-0 ${className}`}>
      <nav className="mx-auto flex w-full items-center justify-between px-6 lg:px-8 " aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" className="text-sm font-semibold leading-6 text-white px-3 border border-gray-800">
            CONTACTO
          </a>
        </div>
      </nav>
